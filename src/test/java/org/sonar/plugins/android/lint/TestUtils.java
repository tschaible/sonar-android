...
public class TestUtils{
  ...
  public static Project mockProject(File baseDir) {
    ...
    when(fileSystem.resolvePath("\\sonar-android-lint-plugin\\target\\test-classes\\HelloWorld\\lint-report.xml")).thenReturn(new File("\\sonar-android-lint-plugin\\target\\test-classes\\HelloWorld\\lint-report.xml"));
